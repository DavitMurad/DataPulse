...
enum MockedData {
    ...
    static func stepsData() -> StepsModel {
    ...
    static func climbedData() -> ClimbedModel {
    ...
    static func getWeightData() -> WeightModel {
    ...
    static func getCaloriesData() -> CaloriesModel {
...
final class MockedHealthKitManager: HKDataManagerProtocol  {
    
    let stepResult: Result<StepsModel, Error>
    let climbedResult: Result<ClimbedModel, Error>
    let weightResult: Result<WeightModel, Error>
    let caloriesResult: Result<CaloriesModel, Error>
    
    init(stepResult: Result<StepsModel, Error> = .success(MockedData.stepsData()),
         climbedResult: Result<ClimbedModel, Error> = .success(MockedData.climbedData()),
         weightResult: Result<WeightModel, Error> = .success(MockedData.getWeightData()),
         caloriesResult: Result<CaloriesModel, Error> = .success(MockedData.getCaloriesData())) {
        
        self.stepResult = stepResult
        self.climbedResult = climbedResult
        self.weightResult = weightResult
        self.caloriesResult = caloriesResult
